...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="UserMainServle?method=1" method="post" id="myform" name="myform">
                ...
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td><input style="height: 28px" type="text" value="" size="85" name="password" class="common-text"></td>
                        </tr>
                        <tr>
