...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="PlayServlet?method=1" method="post" id="myform" name="myform">
            <div class="config-items">
                <hgroup id="main-title" class="thin">
                    <h1 style="font-size: 20px">场次添加</h1>
                </hgroup>
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td><input style="height: 28px" type="text" id="" value="" size="85" name="halId" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>电影编号：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="movId" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>放映时间：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="plaStarttime" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>票价：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="price" class="common-text"></td>
                        </tr>
                        <th></th>
                        <td>
