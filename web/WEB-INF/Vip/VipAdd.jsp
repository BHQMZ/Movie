...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="VipServlet?method=1" method="post" id="myform" name="myform">
            <div class="config-items">
                <hgroup id="main-title" class="thin">
                    <h1 style="font-size: 20px">会员卡添加</h1>
                </hgroup>
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td><input style="height: 28px" type="text" id="" value="" size="85" name="price" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>级别：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="level" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>折扣：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="discount" class="common-text"></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
