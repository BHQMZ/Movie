...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="CustomerServlet?method=1" method="post" id="myform" name="myform">
            <div class="config-items">
                <hgroup id="main-title" class="thin">
                    <h1 style="font-size: 20px">顾客添加</h1>
                </hgroup>
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        <tbody><tr>
                            <th width="15%"><i class="require-red">*</i>编号：</th>
                            <td><input style="height: 28px" type="text"  value="" size="85" name="id" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>姓名：</th>
                            <td><input style="height: 28px" type="text" id="" value="" size="85" name="name" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>性别：</th>
                            <td><input id="man" type="radio" checked name="sex" class="common-text" VALUE="男"/>男
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                <input id="woman" type="radio"  name="sex" class="common-text" VALUE="女"/>女</td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>联系方式：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="phone" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>会员编号：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="vipId" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>会员期限：</th>
                            <td><input style="height: 28px" type="text" value="" size="85" name="viptime" class="common-text"></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
